...
class Wanita extends Component
{
    ...
    public $kunjunganWanita = [];

    public function render()
    {
        return view('livewire.kunjungan.card.wanita');
    }
    ...
    public function tanggalDipilih()
    {
        ...
        $this->kunjunganWanita = DB::table('poli_kliniks')
            ...
            ->selectRaw("
                ...
                COUNT(
                    CASE
                        WHEN pasiens.jenis_kelamin = 'Wanita'
