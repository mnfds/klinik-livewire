...
class GrafikTahunan extends Component
{
    ...
    {
        return view('livewire.kunjungan.lakilaki.grafik-tahunan');
    }
    ...
    {
        $datasets = $this->kunjunganLakiBarTahunan();

        $this->dispatch('update-kunjungan-laki-tahunan-bar', [
            'labelsTahunan' => [
    ...
    private function kunjunganLakiBarTahunan(): array
    {
        $startYear = 2024;
        $endYear   = 2035;
