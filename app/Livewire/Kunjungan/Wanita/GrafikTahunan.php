...
class GrafikTahunan extends Component
{
    ...
    {
        return view('livewire.kunjungan.wanita.grafik-tahunan');
    }
    ...
    {
        $datasets = $this->kunjunganWanitaBarTahunan();

        $this->dispatch('update-kunjungan-wanita-tahunan-bar', [
            'labelsTahunan' => [
    ...
    private function kunjunganWanitaBarTahunan(): array
    {
        $startYear = 2024;
        $endYear   = 2035;
