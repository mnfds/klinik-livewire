...
class CreateByNik extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.pasien.create-by-nik');
    }

    public function searchNIK(GetPatientByNik $patientService)
    {
        $this->validate([
        ...
        try {
            $patient = $patientService->handle($this->nik);
