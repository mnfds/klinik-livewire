...
return new class extends Migration
{
    ...
    {
        Schema::create('riwayat_produk_obat_bundling', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pasien_id')->constrained('pasiens')->onDelete('cascade');
            $table->foreignId('bundling_id')->constrained('bundlings')->onDelete('cascade');
            $table->foreignId('produk_obat_bundling_r_m_id')->constrained('produk_obat_bundling_r_m_s')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('riwayat_produk_obat_bundling_r_m_s');
    }
};
