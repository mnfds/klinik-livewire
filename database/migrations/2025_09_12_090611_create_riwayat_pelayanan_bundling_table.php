...
return new class extends Migration
{
    ...
    {
        Schema::create('riwayat_pelayanan_bundling', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pasien_id')->constrained('pasiens')->onDelete('cascade');
            $table->foreignId('bundling_id')->constrained('bundlings')->onDelete('cascade');
            $table->foreignId('pelayanan_bundling_r_m_id')->constrained('pelayanan_bundling_r_m_s')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('riwayat_pelayanan_bundling_r_m_s');
    }
};
