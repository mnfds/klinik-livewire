...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const ctxKunjunganLakiBulananBar = document.getElementById('grafikKunjunganLakiBulananBar');

        const dataKunjunganLakiBulananBar = new Chart(ctxKunjunganLakiBulananBar, {
            type: 'bar',
            data: {
                labels: [],
                datasets: []
        ...
        Livewire.on('update-kunjungan-laki-bulanan-bar', data => {
            ...
            payload.datasets.forEach(ds => {
                dataKunjunganLakiBulananBar.data.datasets.push(ds);
            });

            dataKunjunganLakiBulananBar.update();
        });
    });
</script>