    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4"> 
        ...
        <div class="card bg-base-100 shadow-md border border-error/50">
            <div class="card-body flex flex-col items-center justify-center">
                ...
                <canvas id="grafikKunjunganLakiHarianPie" class="w-[180px] h-[180px] sm:w-[220px] sm:h-[220px]"></canvas>
            </div>
        </div>
    </div>
</div>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const ctxKunjunganLakiHarianBar = document.getElementById('grafikKunjunganLakiHarianBar');
        const dataKunjunganLakiHarianBar = new Chart(ctxKunjunganLakiHarianBar, {
            type: 'bar',
            data: {
        ...
        Livewire.on('update-kunjungan-laki-harian-bar', (data) => {
            ...
            dataKunjunganLakiHarianBar.update();
        });
    });

    document.addEventListener('DOMContentLoaded', function () {
        const ctx = document.getElementById('grafikKunjunganLakiHarianPie');

        const chartKunjunganLakiPie = new Chart(ctx, {
            type: 'pie',
            data: {
                labels: [],
                datasets: [{
        ...
        Livewire.on('update-kunjungan-laki-harian-pie', payload => {
            ...
            chartKunjunganLakiPie.data.datasets[0].backgroundColor =
                data.datasets[0].backgroundColor;
            chartKunjunganLakiPie.data.datasets[0].borderColor =
                data.datasets[0].borderColor;

            chartKunjunganLakiPie.update();
        });
