<div class="mt-4">
                    ...
                    <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            <h3 class="text-sm font-semibold flex items-center gap-2">
                                ...
                                Rekapitulasi Pendapatan Dan Pengeluaran Perhari
                            </h3>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 w-full lg:w-auto lg:items-end">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto" wire:ignore x-data="{ picker: null }"
                                ...
                                <button type="button" wire:click="openFilterModal" onclick="document.getElementById('applyFilterModalTableHarian').showModal()" class="btn btn-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex flex-col sm:flex-row gap-2">
                                                ...
                                                <button wire:click="unduh('{{ $row['tanggal_raw'] }}')" 
    ...
    {{-- FILTER --}}
    <dialog id="applyFilterModalTableHarian" class="modal" wire:ignore.self>
        <div class="modal-box w-full max-w-xl">
            <h3 class="text-xl font-semibold mb-4">Filter Tabel Rekapitulasi Harian</h3>

            <form x-on:submit.prevent="await $wire.filter(); document.getElementById('applyFilterModalTableHarian').close();" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="col-span-1 sm:col-span-2 flex justify-end gap-2 mt-4">
                    ...
                    <button type="button" class="btn btn-neutral" onclick="document.getElementById('applyFilterModalTableHarian').close()">Batal</button>
                </div>
            </form>
        </div>
    </dialog>
