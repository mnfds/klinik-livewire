                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-10 space-y-6">
                        ...
                        <div class="bg-base-100 shadow rounded-box p-4 pb-7">
                            ...
                            <button wire:click.prevent="createAndKeep" class="btn btn-secondary w-full mb-1" wire:loading.attr="disabled">
                                <span wire:loading.remove><i class="fa-solid fa-bookmark"></i> Keep</span>
                                <span wire:loading.inline>Loading...</span>
                            </button>
                            @endcan
