            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-base-100 border border-base-300 rounded-lg p-4">
                    ...
                    <div class="tabs tabs-lift">
                        ...
                        <input type="radio" name="my_tabs_3" class="tab bg-transparent text-base-content" aria-label="Informasi Kunjungan" style="background-image: none;" />
                        ...
                        {{-- TAB KAJIAN AWAL --}}
                        <input type="radio" name="my_tabs_3" class="tab bg-transparent text-base-content" aria-label="Kajian Awal (Anamnesa)" checked="checked" style="background-image: none;" />
                        <div class="tab-content bg-base-100 border-base-300 p-6">
                            <div class="mt-2">
                        ...
                        <div class="tab-content bg-base-100 border-base-300 p-6">
                            ...
                            @if ($rekammedis->rencanaLayananRM->isNotEmpty() || $rekammedis->rencanaBundlingRM->isNotEmpty() || $rekammedis->obatNonRacikanRM->isNotEmpty() || $rekammedis->obatRacikanRM->isNotEmpty())
                            
                                @if ($rekammedis->rencanaLayananRM->isNotEmpty())
                                    <div class="mt-1">
                                ...
                                @if ($rekammedis->obatNonRacikanRM->isNotEmpty())
                                    <div class="mt-1">
