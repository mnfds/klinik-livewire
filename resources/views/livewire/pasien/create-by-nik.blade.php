    ...
    <form wire:submit.prevent="store" class="p-6 space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="form-control">
                <label class="label"><span class="label-text">No IHS<span class="text-error">*</span></span></label>
                <input wire:model.defer="no_ihs" type="text" class="input input-bordered w-full" required/>
            ...
            <div class="form-control">
                ...
                @if(!empty($name))
                    <span class="text-sm text-gray-500">(Nama Dari Satu Sehat: {{ $name }})</span>
                @endif
            ...
            <div class="form-control">
                ...
                <input type="file" id="foto_pasien" wire:model="foto_pasien"
            ...
            <div class="form-control col-span-full">
                ...
                <textarea wire:model.defer="deskripsi" class="textarea textarea-bordered w-full"
                    rows="3"></textarea>
