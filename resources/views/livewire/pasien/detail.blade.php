                    ...
                    <div class="bg-base-100 overflow-hidden shadow-xs rounded-sm sm:rounded-lg">
                        <div class="p-6 text-base-content space-y-4">
                            ...
                            <div class="tabs tabs-lift">
                                <input type="radio" name="my_tabs_3" class="tab bg-transparent text-base-content" style="background-image: none;" aria-label="Biodata" />
                                ...
                                <input type="radio" name="my_tabs_3" class="tab bg-transparent text-base-content" style="background-image: none;" aria-label="Layanan Tersisa" checked="checked"  />
                                <div class="tab-content bg-base-100 border-base-300 p-6">
                                                                ...
                                                                @foreach($bundling['treatments'] as $t)
                                                                    <li class="flex items-center justify-between">
                                                                        ...
                                                                        <span class="badge badge-outline">
                                                                            Sisa: {{ $t->sisa ?? ($t->jumlah_awal - $t->jumlah_terpakai) }}
                                                                        </span>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
