        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="form-control w-full">
                ...
                <div class="flex w-full gap-2">
                    ...
                    <button type="button" wire:click="searchNameBirtdateGender" class="btn btn-primary">
            ...
            <div class="form-control">
                ...
                <input wire:model.defer="tanggal_lahir" type="date" class="input input-bordered w-full" required/>
