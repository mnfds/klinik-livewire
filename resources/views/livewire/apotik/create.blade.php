                ...
                <div class="lg:col-span-2">
                    <div class="sticky top-20 space-y-6">
                        ...
                        <div class="bg-base-100 shadow rounded-box p-4">
                            ...
                            <div class="space-y-2"
                                x-data="{
                                    obat: @entangle('obat_estetika'),
                                    barang: @entangle('barang_terjual'),

                                    get semuaItems() {
                                        return [
                                            ...Object.values(this.obat || {}),
                                            ...Object.values(this.barang || {})
                                        ];
                                    }
                                }">
                                <template x-for="row in semuaItems" :key="row.uid ?? row.uuid">
                                ...
                                <div class="flex justify-between font-bold my-4 pt-2">
                                    <span>Total Bayar:</span>
                                    <span x-text="semuaItems.reduce((acc, cur) => acc + (Number(cur.subtotal) || 0), 0).toLocaleString('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits:0 })"></span>
                                </div>
                            </div>
                                ...
                                @if ($showPaymentForm)
                                    <div class="border-t border-base-300 mt-4 pt-4 space-y-3">
                                        ...
                                        <div class="form-control">
                                            ...
                                            @error('metode_pembayaran') <span class="text-error text-xs">Mohon Memilih Metode Pembayaran Dengan Benar</span> @enderror
                                        </div>
                                        ...
                                        <button wire:click.prevent="create" class="btn btn-success w-full" wire:loading.attr="disabled">
                                            <span wire:loading.remove><i class="fa-solid fa-check"></i> Konfirmasi & Simpan</span>
                                            <span wire:loading.inline>Menyimpan...</span>
                                        </button>
