                    ...
                    <form wire:submit.prevent="update" class="p-6 space-y-6">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="form-control">
                                <label class="label"><span class="label-text">Username<span class="text-error">*</span></label>
                                <input wire:model.defer="name" id="name" name="name" type="text" autofocus placeholder="username" class="input input-bordered w-full @error('name') input-error @enderror" />
                                @error('name')
                            ...
                            <div class="form-control" x-data="{ showPassword: false }">
                                ...
                                <div class="relative">
                                    <input wire:model.defer="password" :type="showPassword ? 'text' : 'password'"
                                        class="input input-bordered w-full pr-10" placeholder="Kosongkan jika tidak ingin mengubah" />
                                    <button type="button"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            {{-- NIK --}}
                            <div class="form-control">
                                <label class="label"><span class="label-text">NIK Staff</span></label>
                            ...
                            <div class="form-control">
                                ...
                                <input wire:model.defer="ihs" type="text" inputmode="text" class="input input-bordered w-full" />
