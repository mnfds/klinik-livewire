<dialog id="OutstockModalBahanbakuBesar" class="modal" wire:ignore.self x-data x-init="
    Livewire.on('closeOutstockModalBahanbakubesar', () => {
        document.getElementById('OutstockModalBahanbakuBesar')?.close()
    })
">
    <div class="modal-box w-full max-w-md">
        ...
        <form wire:submit.prevent="store" class="space-y-4">
            ...
            <div>
                ...
                <select class="select select-bordered w-full" wire:model.lazy="bahan_baku_besar_id">
            ...
            <div class="modal-action justify-end pt-4">
                ...
                @endcan
                <button type="button" class="btn btn-error" onclick="document.getElementById('OutstockModalBahanbakuBesar').close()">Batal</button>
            </div>
        </form>
    </div>
</dialog>
