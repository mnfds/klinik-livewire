<dialog id="modaleditbahanbakubesar" class="modal" wire:ignore.self x-data x-init="
    Livewire.on('closemodaleditbahanbakubesar', () => {
        document.getElementById('modaleditbahanbakubesar')?.close()
    })
">
    <div class="modal-box w-full max-w-md">
        ...
        <form wire:submit.prevent="update" class="space-y-4">
            ...
            <div class="modal-action justify-end pt-4">
                ...
                @endcan
                <button type="button" class="btn btn-error" onclick="document.getElementById('modaleditbahanbakubesar').close()">Batal</button>
            </div>
        </form>
    </div>
</dialog>