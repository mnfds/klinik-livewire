<dialog id="InstockModalBahanbakubesar" class="modal" wire:ignore.self x-data x-init="
    Livewire.on('closeInstockModalBahanbakubesar', () => {
        document.getElementById('InstockModalBahanbakubesar')?.close()
    })
">
    <div class="modal-box w-full max-w-md">
        ...
        <form wire:submit.prevent="store" class="space-y-4">
            ...
            <div class="modal-action justify-end pt-4">
                ...
                @endcan
                <button type="button" class="btn btn-error" onclick="document.getElementById('InstockModalBahanbakubesar').close()">Batal</button>
            </div>
        </form>
    </div>
</dialog>