<dialog id="storeModalBahanBesar" class="modal" wire:ignore.self x-data x-init="
    Livewire.on('closestoreModalBahanBesar', () => {
        document.getElementById('storeModalBahanBesar')?.close()
    })
">
    <div class="modal-box w-full max-w-md">
        ...
        <form wire:submit.prevent="store" class="space-y-4">
            ...
            <div class="modal-action justify-end pt-4">
                ...
                @endcan
                <button type="button" class="btn btn-error" onclick="document.getElementById('storeModalBahanBesar').close()">Batal</button>
            </div>
        </form>
    </div>
</dialog>