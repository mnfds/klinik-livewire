<dialog id="storeModalUangKeluar" class="modal" wire:ignore.self x-data x-init="
    Livewire.on('closestoreModalUangKeluar', () => {
        document.getElementById('storeModalUangKeluar')?.close()
    })
">
    <div class="modal-box w-full max-w-md">
        <h3 class="text-xl font-semibold mb-4">Tambah Pengajuan</h3>
        ...
        <form wire:submit.prevent="store" class="space-y-4">
            ...
            <div class="modal-action justify-end pt-4">
                ...
                @endcan
                <button type="button" class="btn btn-error" onclick="document.getElementById('storeModalUangKeluar').close()">Batal</button>
            </div>
        </form>
    </div>
</dialog>
